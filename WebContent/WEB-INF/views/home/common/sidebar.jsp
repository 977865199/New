	...
	<div class="tab-content">
	  <div role="tabpanel" class="tab-pane contact active" id="notice">
		...
		<div role="tabpanel" class="tab-pane contact" id="contact">
		  <h2>本站警示:
			  <a href="#" target="_blank" rel="nofollow" data-toggle="tooltip" data-placement="bottom" title=""  data-original-title="禁止发送转载不良信息">禁止发送、转载不良信息</a>
		  </h2>
		  <h4>
		  <a href="#" target="_blank" data-toggle="tooltip" rel="nofollow" data-placement="bottom" title=""  data-original-title="敬请期待">更多信息尽在西华师范大学实时发布系统</a></h4>
	  </div>
	</div>
  </div>
...
<div class="widget widget_sentence">
  ...
  <div class="widget-sentence-link">
	<a href="http://www.cwnu.edu.cn/" title="西华师大官网" target="_blank" >西华师范大学官方网站</a><br>
	<a href="http://210.41.193.28/web/web/mis/" title="教学管理系统" target="_blank" >西华师范大学教学管理系统</a>&nbsp;&nbsp;&nbsp;
  </div>
</div>
</aside>
<script>
